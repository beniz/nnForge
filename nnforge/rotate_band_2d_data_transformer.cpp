...
namespace nnforge
{
		...
		unsigned int max_absolute_band_rotation_y)
	{
		...
		rotate_band_x_distribution = std::uniform_int_distribution<int>(-static_cast<int>(max_absolute_band_rotation_x), static_cast<int>(max_absolute_band_rotation_x));
		rotate_band_y_distribution = std::uniform_int_distribution<int>(-static_cast<int>(max_absolute_band_rotation_y), static_cast<int>(max_absolute_band_rotation_y));
	}
