...
namespace nnforge
{
		...
		float max_stretch_factor)
	{
		...
		rotate_angle_distribution = std::uniform_real_distribution<float>(-max_absolute_rotation_angle_in_degrees, max_absolute_rotation_angle_in_degrees);
		scale_distribution = std::uniform_real_distribution<float>(1.0F / max_scale_factor, max_scale_factor);
		shift_x_distribution = std::uniform_real_distribution<float>(min_shift_right_x, max_shift_right_x);
		shift_y_distribution = std::uniform_real_distribution<float>(min_shift_down_y, max_shift_down_y);
		...
		stretch_distribution = std::uniform_real_distribution<float>(1.0F / max_stretch_factor, max_stretch_factor);
