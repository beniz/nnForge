...
namespace nnforge
{
		...
		float max_absolute_brightness_shift)
	{
		...
		contrast_distribution = std::uniform_real_distribution<float>(1.0F / max_contrast_factor, max_contrast_factor);
		brightness_shift_distribution = std::uniform_real_distribution<float>(-max_absolute_brightness_shift, max_absolute_brightness_shift);
	}
